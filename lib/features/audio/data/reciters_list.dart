...
final reciters = [
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/11.jpg",
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/12.jpg",
    country: "Saudi Arabia",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    country: "Ghana",
    style: "Al-Bazzi 'an Ibn Kathir - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/2.jpg",
    country: "Egypt",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/3.jpg",
    country: "Saudi Arabia",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/4.jpg",
    country: "Saudi Arabia",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/7.jpg",
    country: "Egypt",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    name: "Ali Jaber",
    arabicName: "علي جابر",
    image: "lib/assets/reciters/9.jpg",
    country: "Saudi Arabia",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
  ...
  Reciter(
    ...
    image: "lib/assets/reciters/10.jpg",
    country: "Saudi Arabia",
    style: "Hafs 'an Asim - Murattal",
    totalSurahs: 114,
